...
vector<string> SELECT::print_header_table( ifstream & ifs ){
...
void SELECT::print_data_table( ifstream & ifs ){
	string data;
...
void SELECT::print_one_row( ifstream & ifs,  vector<string> header, pair<string, string> where_condition ){
	int i;
...
vector< pair<string, string> > SELECT::Parse_where ( string where_line ){
...
void SELECT::select_operation( vector <string> cols_select, string from_table, vector< pair<string, string> > where_condition ){
...
void SELECT::Parse_Select( string rest_of_line ){
	stringstream ss;
	ss << rest_of_line;
...
SELECT::SELECT ( string rest_of_line ){
	SELECT::Parse_Select(rest_of_line);
}
